...
class GUI:
    ...
    def compute(self):
        """self.show_result(True, 52.365, {"x": True,"y": False,"z": True,"s": False,
                                        "w": True,"f": True,"h": False,"j": True,
                                        "r": True,"m": False,"k": True,"o": False,
                                        "g": True,"p": False,"v": True,"e": False})
        self.show_result(False, 52.365, "resultdos.txt")"""
        sat, time, result = main(self.get_clause_format(), self.get_clause(), self.get_algorithm())
        print(sat, time, result)
